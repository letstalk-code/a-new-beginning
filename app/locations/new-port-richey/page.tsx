...
export const metadata: Metadata = {
  title: 'Sober Living in New Port Richey, FL',
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(localBusinessSchema('new-port-richey')) }}
      />
        ...
        <div className="container-custom">
          <AnimatedSection>
            <div className="relative h-64 sm:h-80 lg:h-[420px] rounded-xl overflow-hidden shadow-sm max-w-5xl mx-auto">
              <Image
                src="/home-new-port-richey.jpg"
                alt="Sober living home in New Port Richey, Florida"
                fill
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container-custom">
          <AnimatedSection className="max-w-3xl mx-auto">
            <h2 className="font-heading text-3xl font-bold text-forest-900 mb-6">
              Sober Living in New Port Richey, Florida
            </h2>
            <div className="space-y-4 text-olive-700 leading-relaxed">
              <p>
                Our New Port Richey home offers structured sober living in Pasco
                County for men and women who do best with fewer distractions. The
                quiet residential setting suits early recovery: large common areas
                for community, a structured daily routine, and recovery meetings
                nearby. Residents attend a meeting every day, keep a 10:00 PM
                weekday curfew, and complete random drug testing twice a week —
                included in rent along with utilities.
              </p>
              <p>
                We&apos;ve operated as a private-pay Florida non-profit since 2015.
                There&apos;s no move-in fee, payment can be weekly or monthly, and we
                accept residents on MAT (Suboxone or Naltrexone). Men and women live
                in separate homes. Same-day placement is available when you can
                arrive by 8:00 PM — and we can pick up from detox, the airport, or
                jail if getting here is the hard part.
              </p>
              <p>
                Treatment centers and case managers in Pasco County and across Tampa
                Bay refer clients here for step-down housing. Call{' '}
                <a href="tel:+17272027307" className="text-terra-700 font-semibold hover:underline">
                  (727) 202-7307
                </a>{' '}
                to check bed availability in New Port Richey today.
              </p>
            </div>
          </AnimatedSection>
        </div>
